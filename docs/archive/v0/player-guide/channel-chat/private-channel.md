...
プライベートを作成する場合は [`/lc channel create`](../commands/lc/channel.md) コマンドで，プライベート設定引数に `true` を指定します．
...
招待するには，[`/lc channel invite`](../commands/lc/channel.md#lc-channel-invite-プレイヤーid) コマンドを使用します．
