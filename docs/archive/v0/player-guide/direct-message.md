...
メッセージを送信するには [`/tell`](./commands/tell.md) コマンドを使用します．
...
クイックリプライを使用するには [`/reply`](./commands/reply.md) コマンドを使用します．
...
通知設定を変更するには [`/lc settings`](./commands/lc/settings.md) コマンドを使用します．
