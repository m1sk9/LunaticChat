...
4. Modify the [configuration](/en/docs/configuration) as needed and restart the server
...
4. See [Velocity Integration](/en/docs/features/velocity) for details

## Next Steps

- [Configuration](/en/docs/configuration) - Review all settings in `config.yml`
- [Direct Message](/en/docs/features/direct-message) - How to use the DM feature
- [Channel Chat](/en/docs/features/channel-chat) - How to use the channel feature
- [Command Reference](/en/docs/reference/commands) - Reference for all commands
